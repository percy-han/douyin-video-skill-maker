#!/usr/bin/env python3
"""
批量下载博主所有视频 - 修复Python 3.9 asyncio问题
Author: Claude
Date: 2026-04-17
"""
...
╔══════════════════════════════════════════════════════════╗
║                                                          ║
║      🎬 抖音批量下载器 (Python {platform.python_version()})                ║
║                                                          ║
║      一键下载博主所有视频                                 ║
║                                                          ║
╚══════════════════════════════════════════════════════════╝
    ...
    if sys.version_info < (3, 10):
        print("⚠️  警告: 当前Python版本较旧")
        print(f"   当前版本: {platform.python_version()}")
        print(f"   推荐版本: 3.10+")
        print("")
        print("如果遇到错误，请升级Python:")
        print("  sudo yum install -y python3.11  # Amazon Linux")
        print("  或参考: fix_ec2_python.sh")
        print("")
